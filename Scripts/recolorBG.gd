...
func _setBackground() -> void:
    ...
    $MarginContainer/HexCode.modulate = Color((colorFinal[0] + 1) / 256, (colorFinal[1] + 1) / 256, (colorFinal[2] + 1) / 256, 1)
    $MarginContainer/PuzzleCounter.modulate = Color((colorFinal[0] + 1) / 256, (colorFinal[1] + 1) / 256, (colorFinal[2] + 1) / 256, 1)
    ...
    BGcolor = colorFinal
    $MarginContainer/HexCode.text = "#" + tempString[0] + tempString[1] + tempString[2]
